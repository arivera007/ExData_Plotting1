...
par(mfcol = c(2,2))                     ## Create matrix to place the different graphics.

plot(myDateTime, myData$Global_active_power, type="l", ylab = "Global Active Power", xlab="")
...
plot(myDateTime, myData$Voltage, type="l", ylab = "Voltage", xlab="datetime")

plot(myDateTime, myData$Global_reactive_power, type="l",  ylab = "Global_reactive_power", xlab="datetime")
